...
- (void)initializer {
    ...
    _cellScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.bounds), _height)];
    _cellScrollView.contentSize = CGSizeMake(CGRectGetWidth(self.bounds) + [self utilityButtonsPadding], _height);
    ...
    _scrollViewContentView = [[UIView alloc] initWithFrame:CGRectMake([self leftUtilityButtonsWidth], 0, CGRectGetWidth(self.bounds), _height)];
//    _scrollViewContentView.backgroundColor = [UIColor whiteColor];
    ...
    self.rightLabel = [[UILabel alloc]initWithFrame:CGRectMake(screenWidth-220, 12, 200, 20)];
    self.rightLabel.font = [UIFont systemFontOfSize:15];
    self.rightLabel.textAlignment = NSTextAlignmentRight;
//    self.rightLabel.textColor = 
//    [self.scrollViewContentView addSubview:self.rightLabel];
}
...
- (void)rightUtilityButtonHandler:(id)sender {
    ...
    if (self.rightBtnBlock) {
        self.rightBtnBlock(utilityButtonTag);
    }
    /**Alvin add end*/
...
- (void)leftUtilityButtonHandler:(id)sender {
    ...
    if (self.LeftBtnBlock) {
        self.LeftBtnBlock(utilityButtonTag);
    }
    /**Alvin add end*/
...
{
    [[NSNotificationCenter defaultCenter]postNotificationName:SWTableViewCellBeginScrollNotice object:self];
}
