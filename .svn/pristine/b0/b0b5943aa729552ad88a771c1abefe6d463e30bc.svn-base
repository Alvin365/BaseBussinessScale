...
@implementation TransactionDataSyncRespFrame

-(instancetype)initWithProductId:(int)productId status:(BOOL)success {
    self = [super init];
    if (self) {
        Byte bytes[] = {0xA5, 0x01, 0x04, 0x32, (Byte)((productId >> 8) & 0xFF), (Byte)(productId & 0xFF), (Byte)(success ? 0x01 : 0x00), 0x00};
