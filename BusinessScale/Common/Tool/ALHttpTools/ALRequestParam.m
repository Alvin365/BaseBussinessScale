...
NSString * const ALHttpGet      = @"GET";
NSString * const ALHttpPost     = @"POST";
NSString * const ALHttpDelete   = @"DELETE";
NSString * const ALHttpPut      = @"PUT";
NSString * const ALHttpPatch    = @"PATCH";
NSString * const ALHttpHead     = @"HEAD";

@implementation ALPostData
...
- (void)addParams:(NSDictionary *)params
{
    ...
    if (params) {
        [_dynamicParam addEntriesFromDictionary:params];
    }
}
...
- (id)httpBody {
    if (_httpBody == nil) {
        return nil;
    }else if ([_httpBody isKindOfClass:[NSData class]]){
        return _httpBody;
    }
...
- (void)addPostData:(ALPostData *)data {
    if (_postDatas == nil) {
...
- (void)addFile:(NSData *)fileData forKey:(NSString *)key fileName:(NSString *)fileName mimeType:(NSString *)mimeType {
    ...
    ALPostData *file = [[ALPostData alloc] init];
